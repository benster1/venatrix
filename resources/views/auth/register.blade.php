...
@section('content')
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div align="right">
                        <a href="/login" style="color:black;" type="reset" class="btn btn-default"> Click Here to Login</a>
                    </div>
                </br>
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" placeholder='Firstname' type="text" class="form-control" name="firstname" value="{{ old('firstname') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="lastname"  placeholder='lastname' type="text" class="form-control" name="lastname" value="{{ old('lastname') }}" required autofocus>
