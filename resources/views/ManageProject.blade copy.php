...
<!--/Administrator-->
  ...
  <div class="row">
      <div class="panel panel-default">
        <div class="panel-heading"> <h4>Manage BaseCamp</h4></div>
        <div class="panel-body">
...
<form action="/editProject" method="get">
        <input type="hidden" name="idProject"   value="25" >
        <input type="submit" value="Update Project Details" class="btn btn-outline btn-default"/>
</form>

         <div align="left">
                <a href="/manage?id=25"   ><img width="6%" src="/img/back.png">  </a>
                <a href="/home"   > <img width="10%" src="/img/home.png">
  </a>
        </div>
