...
<div align="right"> <table border="4"><tr><td>
 <a id='logout' href="/userlogout">
  ...
  <div class="row">
    ...
    <div class="panel-heading"><h2><div align="center">Create New Test Case</div></h2></div>
        <div class="panel-body">
      ...
      <div class="panel-body">
              ...
              <form method="get" action="/newTestCase/26"  onclick="myFunctionOnLOAD(this.value)">
<input type="hidden" name="NameProject" id="NameProject" value="26" >
<a href="/CreateTCManualyTester"  style="color:black;" class="btn btn-outline btn-default" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Manualy&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
</form></br>
            <form>
        <a href="/SiteMapTester" style="color:black;"  class="btn btn-outline btn-default" >View Site Map  </a>
</form>
</br>
    ...
    <a href="/ManageTCMenu2Tester" ><img width="2%" src="/img/back.png"> </a>
