...
<!--/Administrator-->
  ...
  <div class="row">
      <div class="panel panel-default">
        <div class="panel-heading"><h4>Create New Test Case</h4></div>
        <div class="panel-body">
      ...
      <div class="panel-body">
              ...
              <form method="get" action="/newTestCase/25"  onclick="myFunctionOnLOAD(this.value)">
<input type="hidden" name="NameProject" id="NameProject" value="25" >
<input type="submit" value="Manualy"  class="btn btn-outline btn-default" onclick="myFunctionLOAD(this.value)">
</form></br>
            <form>
        <a href="/createNode?projectname=BaseCamp"  class="btn btn-outline btn-default" >View Site Map  </a>
</form>
</br>
<div align="left" class="form-group">
    <a href="/manageTC/25" ><img width="6%" src="/img/back.png"> </a>
                    <a href="/home"   > <img width="10%" src="/img/home.png">
  </a>
</div>
