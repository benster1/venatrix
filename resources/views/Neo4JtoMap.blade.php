...
$url='http://www.basecampcs.com';
        ...
        $nodenode->save();
            $query = "CREATE(
                                root:NODE_TREES {name:'".$node->nodeName."', node_id:".$node->id.", url:'".$node->url."', description:'".$node->description."', nodeParent_id:'".$nodenode->nodeparent_id."' })
...
@section('content')
                <div class="panel-heading">SiteMap from NEO4J</div>
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
       ...
       <? $query='MATCH (n:NODE_TREESssssss)<-[:ParentOf]-(parent:NODE_TREESssssss)RETURN n.node_id,n.name, parent.node_id, parent.url, n.url, parent.name LIMIT 25';
