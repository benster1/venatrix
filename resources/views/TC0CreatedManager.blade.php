...
if(isset($_GET['TC']))  $tc=$_GET['TC'];?>
	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="alert panel-heading" role="alert">
				<h3>
					{{$tc}} Created Successfuly  
						...
						<h3><div align="center">Details of Test Case <b>{{$tc}}</b></div></h3>
...
<a href="/CreadentialGenerateMapManager" style="color:black;" class="btn btn-outline btn-default">Execute TC0</a>
            </br>
            </br>
            </div>
            <div align="left">
                 <a href="/AllTCManager" ><img width="2%" src="/img/back.png"></a>
                    <a href="/homeManager"   > <img width="5%" src="/img/home.png">
  </a>
