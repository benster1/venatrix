...
<!--/Administrator-->
	...
	<div class="row">
            ...
            <div class=" panel-default" role="alert">
                <h3>
                    Would You Like To Update The Test Case ?               
                </h3> 
                
            </div>
            				<div class="panel-heading">Edit Test Case <b>TC0</b></div>

				<div class="panel-body" >
										<form action="/editTC" method="Post">
                           <input type="hidden" name="_token" value="WjDZtpdriCIZQw71n0ou8t8nGUhwv6J1dc6o9ein">
							<input class="form-control" type="hidden" name="tc_id" value="61" required="true">
						<div class="form-group">
							<label>Test's Name *</label>
							<input class="form-control" type="text" name="tc_name" value="TC0" required="true">
						</div>
						<div class="form-group">
							<label>URL *</label>
							<input class="form-control" type="text" name="tc_url" value="http://mikeisabella.com/" required="true">
						</div>

							<div class="form-group">
								<label>Decription *</br></label>
								<textarea    rows="10" cols="123" name="tc_desc"  class="form-group">
							...
							<div class="form-group">
								...
								<textarea    rows="10" cols="123" name="tc_coms" class="form-group" >
									Generate the SiteMap of http://mikeisabella.com/
								</textarea>
							</div>
...
<a href="/TC0UpdatedManager" style="color:black;" class="btn btn-outline btn-default">Save</a>

<button type="reset" value="Cancel" style="color:black;" class="btn btn-outline btn-default"> Clear</button>
<div>         
</form></br>
    <a href="/TC0CreatedManager" ><img width="2%" src="/img/back.png"></a>
