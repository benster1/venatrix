...
<!--/Administrator-->
    ...
    <div class="row">
            ...
            <div align="center" class="panel-heading" role="alert">
                <h3>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input class="form-control" name='projectname' placeholder="No Space in the ProjectName" type="text" value="MikeIsabella" required="true">
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-group">
                        <label>URL *</label>
                        <input class="form-control" name='url' value="http://mikeisabella.com/" type="text" required="true">
                    </div>   
                </div>
                <!--<div class="form-group">
                    <div class="form-group">
 ...
 <div align="left" class="form-group">
                     ...
                     <a href="/NotificationCreateProjectManager" style="color:black;" class="btn btn-outline btn-default">Save</a>
