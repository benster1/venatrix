...
<!--/Administrator-->
  ...
  <div class="row">
    ...
    <div class="panel-heading"><h2><div align="center">Manage Test Cases</div></h2></div>
        <div class="panel-body">
      ...
      <div class="panel-heading">Create New TestCase For Project MikeIsabella</div>

      <div class="panel-body">
        
        <div>
              
        <a href="/ManageTCMenuTester" style="color:black;" class="btn btn-outline btn-default" >Create New TestCase </a>

            </div>
            </br>
            <div>
        <a href="/viewAllTCTester" style="color:black;" class="btn btn-outline btn-default" >&nbsp;&nbsp;View All TestCases&nbsp;&nbsp;&nbsp;</a>
</form></div></br>
