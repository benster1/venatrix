...
<!--/Administrator-->
	...
	<div class="row">
        ...
        <div id='hidePanel'  align="center" class="alert alert-default" role="alert">
            ...
            <h3>
                Test Case Executed Successfuly !   
						...
						<div class="panel-heading">Details of Test Case <b>TC0</b></div>
			...
			<div class="panel-body" >
				...
				<div class="form-group">
					...
					Generate the SiteMap of https://www.harristeeter.com/
				</div>
				...
				<div class="form-group">
					...
					<label>TC Run Status</br></label>
					 <font color='orange'>Pass<b></b></font>
									</div>
				<label>TC Status</br></label>
				 <font color='black'><b>Executed</b></font>
							</div>
			<div align="center">
				<a href="/actionTC/61?action=2/61"  class="btn btn-outline btn-default">Edit TestCase</a>
			</div>
		</br>
			...
			<!-- test steps-->
												<!----> 
			<div align="left">
                 <a href="/viewTestsOfProject/26" ><img width="6%" src="/img/back.png"></a>
                    <a href="/home"   > <img width="10%" src="/img/home.png">
  </a>
