            ...
            <div class="alert panel-default" role="alert">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input class="form-control" name='projectname' value='BaseCamp' type="text" required="true">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input class="form-control" name='url' type="text" value='http://www.basecampcs.com' required="true">
                    </div>   
                </div>   
              ...
              <div>              
                    <input type="submit" name='create'  value="Save" class="btn btn-outline btn-default">
                    <input type="reset" class="btn btn-outline btn-default" value="Clear">
                </div>
                </form>  
                              </br>
                ...
                <a href="/manageProject/25"  ><img width="6%" src="/img/back.png">  </a>
        </div>              
