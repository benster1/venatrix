      ...
      <div class="alert alert-default" role="alert">
        <h3>
          Would You Like To Create A New Test Case Manualy?  
            				...
            				<div class="panel-heading">Add TestCase To Project <b>BaseCamp</b></div>

				<div class="panel-body" >
										<form method="post" action="/createTC">
                           <input type="hidden" name="_token" value="WjDZtpdriCIZQw71n0ou8t8nGUhwv6J1dc6o9ein">
						<div class="form-group">
							<input class="form-control" name="project_id" type="hidden" value="25" required="true">
						</div>
						<div class="form-group">
							<label>URL *</label>
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea    name="tc_desc" rows="10" cols="177" class="form-group" required="true">
								</textarea>
							</div>
							...
							<div class="form-group">
								...
								<textarea   name="tc_coms" rows="10" cols="177" class="form-group">
								</textarea>
							</div>
							<!--<div class="form-group">
...
<div class="form-group">
    <a href="/manageTCMenu/25"><img width="6%" src="/img/back.png"> </a>
                    <a href="/home"   > <img width="10%" src="/img/home.png">
  </a>
      </div></div>
