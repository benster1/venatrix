...
<!--/Administrator-->
  ...
  <div class="row">
      <div class="panel panel-default">
        <div class="panel-heading"> <h4>Manage MikeIsabella</h4></div>
        <div class="panel-body">
      ...
      <div class="panel-body">
        ...
        <input type="hidden" name="idProject"   value="25" >
        <input type="button" value="Manage Test Ressources" onclick="return  confirm('No Yet Implemented')" class="btn btn-outline btn-default"/>
</form>
              </br>
              </br>
...
<form action="/editProject" method="get">
        <input type="hidden" name="idProject"   value="25" >
        <a href="/EditProjectManager" class="btn btn-outline btn-default" >Update Project Details<a/>
</form>

         <div align="left">
                <a href="/ManageProjectTCManager"   ><img width="2%" src="/img/back.png">  </a>
