...
<script type="text/javascript">
 ...
 <link rel="shortcut icon" href="/img/VenatriX6X.png">
    <title>VenatriX.io By MikeIsabella</title>
            ...
            <div class="alert panel-default" role="alert">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input class="form-control" name='projectname' value='MikeIsabella' type="text" required="true">
                        <input class="form-control" name='idProject' value='25' type="hidden" required="true">
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-group">
                        <label>URL (Optional)</label>
                        <input class="form-control" name='url' type="text" value='http://mikeisabella.com/' required="true">
                    </div>   
                </div>   
              ...
              <div>              
                    <a href="/NotifEditProjectManager" style="color:black;" class="btn btn-outline btn-default" >Save</a>
                ...
                <div align="left">
                <a href="/ManageResourcesProject"  ><img width="2%" src="/img/back.png">  </a>
