...
<div class="container" width="100%">
  ...
  <div class="panel panel-default">
          ...
          <td>
            <div class="form-group">
              <form method="get" action="/manageTCMenu2"> <!-- getTestsOfProject-->
                <select required name='id' class="form-control">
                                    <option value="26">MikeIsabella</option>
            ...
            <td>
              <div class="form-group">
                ...
                <a href="/ManageTCMenu2Tester" style="color:black;"  class="btn btn-outline btn-default">Go</a>
              </div>
            </td>
          </tr>
        </form>
    ...
    <div> 
       ...
       <div align="left"><a href="/homeTester"   ><img width="5%" src="/img/home.png">  </a></div>
