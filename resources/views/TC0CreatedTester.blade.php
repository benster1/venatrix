...
<body>
    <div id="wrapper">
                                                <div align="center">
                    <i>
                       <u> <h4>Gerry&nbsp;Manigbas</h4> </u>logged as <b>
                                                                                                                                                       </br>
                                                                                                                                                                            Manager
                                                                                    </br>
                                                                                                                                                                        </br>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/homeManager">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <!--
                        <li>
                    <a href="/homeTester"   > <img width="10%" src="/img/home.png">
  </a>
	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="alert panel-default" role="alert">
				<h3>
					{{$tc}} Created Successfuly  
				</h3> 
			</div>
						 
        
						<div class="panel-heading">Details of Test Case <b>{{$tc}}</b></div>

			<div class="panel-body" >
								<input class="form-control" type="hidden" name="id" value="61" required="true">
				...
				<div class="form-group">
					...
					Generate the SiteMap of http://mikeisabella.com/
				</div>
				...
				<div class="form-group">
					...
					<label>Created date</br></label>
					2018-06-09 20:40:57
				</div>
				<div class="form-group">

					<label>Updated by</br></label>
					No Update
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<label>Executed by</br></label>
					No Update
				</div>
				<div class="form-group">

					<label>Executed date</br></label>
					2018-06-09 20:40:57
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<label>URL</br></label>
					http://mikeisabella.com/
				</div>
				<div class="form-group">

					<label>TC Run Status</br></label>
					 <font color='grey'><b>No Run</b></font>
									</div>
				<label>TC Status</br></label>
				 <font color='black'><b>Approved</b></font>
							</div>
			<div align="center">
				<a href="/TC0EditManager" style="color:black;" class="btn btn-outline btn-default">Edit TestCase</a>
			</div>
		</br>
			...
			<div class="alert panel-default" role="alert">
				<h3>
					Would you like to Execute the {{$tc}} ?  
				</h3> 
				When executing the {{$tc}}, a SiteMap of the Project will be Generated, it will help the Tester to Create TestCases.
			</div>
			
<!--			<div align="center">
				<a href="/credentials/61"  class="btn btn-outline btn-default">Run The TestCase TC0</a>
			</div>
-->
 <!--
			<div align="left">
                 <a href="/homeTester"class="btn btn-outline btn-default">Back To Home</a>
                 <a href="/viewTestsOfProject/26" class="btn btn-outline btn-default">Back</a>

			</div>
		-->
									<div align="center">
				<a href="/CreadentialGenerateMapManager" style="color:black;" class="btn btn-outline btn-default">Execute {{$tc}}</a>
			</div>
						<!----> 
			<div align="left">
                 <a href="/viewTestsOfProject/26" ><img width="2%" src="/img/back.png"></a>
      <a href="/homeTester"   ><img width="5%" src="/img/home.png">  </a></div>
  </a>
...
<!--
  ...
  function openWdefaultw() {
    myWin = wdefaultw.open('/credentials/61', 'login', 'width=400,height=300');
